  ...
  return (
    <main className="min-h-screen p-8 bg-gradient-to-br from-pink-100 to-blue-100">
      <div className="max-w-6xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8">
        ...
        <div className="mb-8">
          <textarea
            className="w-full h-32 p-4 rounded-lg border border-pink-200 bg-pink-50 focus:ring-2 focus:ring-pink-300 focus:border-transparent resize-none"
            placeholder="オーナー入力"
          />
        </div>
        ...
        <div className="mb-8">
          <textarea
            ...
            className="w-full h-24 p-4 rounded-lg border border-blue-200 bg-blue-50 focus:ring-2 focus:ring-blue-300 focus:border-transparent resize-none"
        ...
        <div className="grid grid-cols-3 gap-6">
          {[1, 2, 3].map((num) => (
            ...
            >
              ...
              <textarea
                className="w-full h-64 p-4 rounded-lg border border-purple-200 bg-white/70 focus:ring-2 focus:ring-purple-300 focus:border-transparent resize-none"
